...
fig = plt.figure()
df.plot(x='ml', y="280 nm", secondary_y=['360 nm', '410 nm'], title='SEC 20210803', figsize=(15, 10), fontsize=15,
        xticks=np.arange(0.0, 3.66, 0.1), xlim=[0.5, 2.5], xlabel='Elution volume', ylabel='Absorption [mAU]',
        grid=True)
